    ...
    return (
        <footer className="pt-14 pb-16 border-t border-gray-100 dark:border-zinc-700">
            <div className="container text-secondary dark:text-secondary-dark text-sm flex justify-between">
                <p>
                    [game website] is open-sourced on <a href="https://github.com/SVWEFSBRWHWBCOTSEID/game-website" rel="noopener noreferrer" className="text-blue-500 hover:underline">GitHub</a>.
                    <br />
