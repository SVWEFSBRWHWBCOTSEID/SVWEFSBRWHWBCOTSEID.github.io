...
export default function ProfileSidebar() {
    ...
    return (
        <Tab.List as="aside" className="flex md:flex-col flex-none pt-1 w-32 lg:w-64 xl:w-72 transition-[width] duration-200">
            {/* TODO: styling? */}
            <Tab className="group text-secondary flex gap-3 items-center hover:bg-content-secondary/50 ui-selected:bg-content rounded-t md:rounded-r-none md:rounded-l pl-4 pr-4 md:pr-8 py-3 transition duration-150">
