...
export default function ProfileSidebarItem(props: ProfileSidebarItemProps) {
    return (
        <div className="group text-secondary flex gap-3 items-center hover:bg-content-secondary/50 rounded-l pl-4 pr-8 py-3 transition duration-150">
            {/* TODO: icon */}
            <GiPotato className="text-4xl group-hover:text-blue-500" />
            <div>
                <h5 className="uppercase font-light">{props.name}</h5>
