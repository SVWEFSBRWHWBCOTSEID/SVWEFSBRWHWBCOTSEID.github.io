...
export default function QuickPairingButton(props: QuickPairingButtonProps) {
    return (
        <button
            className="flex flex-col gap-1.5 items-center justify-center rounded font-light text-secondary hover:text-primary border border-tertiary p-6 bg-content-secondary/50 hover:bg-theme-orange/20 transition duration-200"
